...
class DirectoryManager:
    ...
    def move_to_processing(self, chunk: AudioChunk) -> AudioChunk:
        ...
        return AudioChunk(path=dest, created_at=chunk.created_at, retry_count=chunk.retry_count)
    ...
    def move_to_pending(self, chunk: AudioChunk) -> AudioChunk:
        ...
        return AudioChunk(path=dest, created_at=chunk.created_at, retry_count=new_chunk.retry_count)
